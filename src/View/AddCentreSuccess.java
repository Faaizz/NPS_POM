...
public class AddCentreSuccess extends JPanel{
	...
	public void setHomeRedirect(RedirectEventListener toHomeRedirect) {
	...
	public AddCentreSuccess() {
		...
		lblSuccessMsg = new JLabel("You have successfully added a new Centre.");
