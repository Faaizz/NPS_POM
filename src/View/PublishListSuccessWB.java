...
public class PublishListSuccessWB {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PublishListSuccessWB window = new PublishListSuccessWB();
	...
	private void initialize() {
		...
		JLabel lblAddInmateHeading = new JLabel("Pardon List");
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				...
				{null, "Centre No", null},
				{null, "Name", null},
				{null, "Date of Birth", null},
				{null, "Gender", null},
				{null, "PoM Points", null},
			},
			new String[] {
				"Inmate ID", "Centre No", "Total Points"
			}
		));
		...
		scrollPane.setBounds(63, 90, 765, 242);
		...
		JButton btnPardonRequirements = new JButton("Pardon Requirements");
		btnPardonRequirements.setFont(new Font("Dialog", Font.PLAIN, 16));
		btnPardonRequirements.setBounds(355, 38, 250, 40);
		panel.add(btnPardonRequirements);
	}
}
