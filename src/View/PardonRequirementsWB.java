...
public class PardonRequirementsWB {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PardonRequirementsWB window = new PardonRequirementsWB();
	...
	private void initialize() {
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				{"Chnage from old ways", "30", "=135"},
				{"Good Behaviour", "30", "=135"},
				{"Conduct", "20", "=90"},
				{"Attitude towards work", "20", "=90"},
				{"Total", "100", "=450"},
			},
			new String[] {
		...
		scrollPane.setBounds(130, 90, 601, 177);
