...
public class AddInmateSuccess extends JPanel{
	...
	public AddInmateSuccess() {
		...
		lblSuccessMsg = new JLabel("You have successfully added a new Inmate.");
		...
		btnBackToHome.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				homeRedirect.redirectActionPerformed(toHomeEvent);
	...
	public void setHomeRedirect(RedirectEventListener homeRedirect) {
